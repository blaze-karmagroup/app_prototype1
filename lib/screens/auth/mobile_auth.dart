...
class _MobileLoginPageState extends State<MobileLoginPage> {
  ...
  Future<void> _checkNumberAndLogin() async {
    final phoneNumber = _mobileController.text.trim();
    print("entered no: $phoneNumber");
    ...
    try {
      ...
      if (response == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Number not registered. Contact Admin.")),
        );
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: _checkNumberAndLogin,
                    child: const Text(
                      'Send OTP',
